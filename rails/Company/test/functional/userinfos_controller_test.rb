...
class UserinfosControllerTest < ActionController::TestCase
  ...
  test "should create userinfo" do
    assert_difference('Userinfo.count') do
      post :create, userinfo: { Interest: @userinfo.Interest, hobbies: @userinfo.hobbies, location: @userinfo.location, name: @userinfo.name }
    end
  ...
  test "should update userinfo" do
    put :update, id: @userinfo, userinfo: { Interest: @userinfo.Interest, hobbies: @userinfo.hobbies, location: @userinfo.location, name: @userinfo.name }
    assert_redirected_to userinfo_path(assigns(:userinfo))
  end
